function makeCustomizedHalloRichTextEditable(id, plugin_keys) {
    if (typeof plugin_keys !== "undefined"){
	var localHalloPlugins = {};
	$.each(plugin_keys, function(idx, value) {
	    localHalloPlugins[value] = halloPlugins[value];
	});
    } else {
	var localHalloPlugins = halloPlugins;
    }
    console.log("local:\n" + localHalloPlugins);
    console.log("global:\n" + halloPlugins);
    var input = $('#' + id);
